      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-16">
        ...
        <div className="text-center mb-16">
          <h2 className="text-2xl md:text-3xl font-display font-semibold mb-4">
            Your Secrets Stay Secure, Or Double Your Money Back
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
            We stand behind our security promises with the industry's strongest guarantee.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-10">
            <div>
              <h3 className="text-sm font-semibold mb-4 text-foreground/90">Solutions</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">Secure Devices</a></li>
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">Encrypted Communications</a></li>
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">Threat Intelligence</a></li>
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">Emergency Protocols</a></li>
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">Compliance Solutions</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">About Us</a></li>
                ...
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">Press & Media</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">Security Blog</a></li>
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">Documentation</a></li>
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">Compliance Center</a></li>
                <li><a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors">Privacy Statement</a></li>
